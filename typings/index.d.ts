declare module 'fs-nextra' {
	...
	export function createReadStream(path: string|Buffer|URL, options?: readStreamOptions|string): Promise<NodeJS.ReadableStream>;
	export function createWriteStream(path: string|Buffer|URL, options?: writeStreamOptions|string): Promise<NodeJS.WritableStream>;
